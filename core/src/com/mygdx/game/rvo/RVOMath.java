...
final class RVOMath {
    ...
    /**
     * Computes the determinant of a two-dimensional square matrix with rows consisting of the
     ...
     * @return Positive when the point3 lies to the left of the line passing through point1 and
     *     point2.
     */
